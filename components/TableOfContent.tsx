...
export default function TableOfContents({
  ...
  const [desktopOpen, setDesktopOpen] = useState(false); // desktop toggle — starts collapsed
      ...
      <nav className="hidden xl:block sticky top-24 self-start">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-3 border-b border-gray-50 text-sm font-semibold text-gray-900 hover:bg-gray-50 transition-colors"
          >
