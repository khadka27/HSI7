...
import { LayoutDashboard, FolderOpen, Layers, Package, ShoppingBag, ArrowLeft, Settings, LogOut, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="md:hidden bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="text-gray-400 text-xs flex items-center gap-1">
